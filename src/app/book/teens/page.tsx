...
export default async function BookTeensPage() {
  ...
  const trialClasses = (settings || [])
    .filter((s: Record<string, unknown>) => {
      ...
      return cls && cls.is_active && cls.programme === "teens";
    })
  ...
  return <BookingPageClient programme="teens" programmeLabel="Teens" slots={slots} />;
}
